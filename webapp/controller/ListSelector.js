sap.ui.define([
	...
	return BaseObject.extend("CRUD.CRUD.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias CRUD.CRUD.model.ListSelector
		 */
		 ...
		 * @return {CRUD.CRUD.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
