sap.ui.define([
	"CRUD/CRUD/controller/BaseController",
	...
	return BaseController.extend("CRUD.CRUD.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("UserCollection", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("UserCollection", oData);
