		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "UserCollection (0)"
						}),
						success: function() {
							Opa5.assert.ok(true, "The list header displays 'UserCollection (0)'");
						},
				...
				theListShouldHaveAllEntries: function() {
					...
					// retrieve all UserCollection to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "UserCollection (" + iExpectedLength + ")"
								}),
								success: function() {
